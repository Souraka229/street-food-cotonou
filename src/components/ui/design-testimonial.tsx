...
const testimonials = [
  {
    quote: "Une tuerie. Les portions sont généreuses et le prix reste doux.",
    author: "Aïcha D.",
    role: "Cliente régulière",
    company: "Haie Vive",
  },
  {
    quote: "Meilleur spaghetti de Cotonou, sans discussion. On revient demain.",
    author: "Rodrigue K.",
    role: "Étudiant",
    company: "Cotonou",
  },
  {
    quote: "Service rapide, tout est chaud, et l'ambiance est vraiment street.",
    author: "Fatou B.",
    role: "Livreuse",
    company: "Zone Aéroport",
  },
];
